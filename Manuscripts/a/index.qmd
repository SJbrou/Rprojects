...
authors:
  - name: Stan Brouwer
    affiliation: CapGemeni Office Solutions
    # roles: writing
    # corresponding: true
...
```{r load_utility_data, message=FALSE, warning=FALSE, echo=FALSE}
#| label: fig-utility
#| fig-cap: Assumed utility usage. Note that energy meters measure net flow, and thus gross solar and power might differ. 
#| fig-height: 3
...
```{r utility-plot, echo=FALSE, warning=FALSE, message=FALSE}
#| label: tbl-utility
...
```{r energy_intensity, echo=FALSE, message=FALSE}
#| label: fig-energy-intensity
#| fig-cap: "CO₂ emissions of the dutch energy production over time"
#| fig-height: 3
...
```{r emissions, echo=FALSE, message=FALSE}
#| label: fig-emissions
#| fig-cap: "Monthly CO₂ Emissions from Energy and Gas"
#| fig-height: 4
...
```{r emissions-aggregate, echo=FALSE, warning=FALSE, message=FALSE}
library(dplyr)
library(knitr)
...
<details>
<summary>Details</summary>
```{r emissions-table, echo=FALSE, warning=FALSE, message=FALSE}
#| label: tbl-emissions
